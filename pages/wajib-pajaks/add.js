...
function WajibPajaksAdd() {
  ...
  const wajibPajaksHandler = async ({
    namaPemilik,
    npwpd,
    alamatLengkap,
    kec,
      ...
      <div className="lg:flex lg:-mx-4">
        <div className="w-full lg:px-4">
          <div className="card p-5">
            ...
            <form onSubmit={handleSubmit(wajibPajaksHandler)}>
...
export default dynamic(() => Promise.resolve(WajibPajaksAdd), { ssr: false });
