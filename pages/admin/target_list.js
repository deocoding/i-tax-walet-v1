      ...
      <section className="breadcrumb lg:flex items-start">
        <div>
          ...
          <ul>
            ...
            <li>Daftar Target Penerimaan</li>
          </ul>
        </div>
          ...
          <table className="table table-auto table_hoverable w-full">
            <thead>
              <tr>
                ...
                <th className="text-center uppercase">Target</th>
                <th className="text-center uppercase">Realisasi</th>
                <th className="text-center uppercase">Dasar Hukum</th>
            ...
            <tbody>
              <tr>
                ...
                <td>2012</td>
                <td className="text-center">Rp210.000.000</td>
                <td className="text-center">Rp200.000.000</td>
                <td className="text-center">Perwalikota No. ... Tahun ....</td>
              ...
              <tr>
                ...
                <td>2011</td>
                <td className="text-center">Rp200.000.000</td>
                <td className="text-center">Rp190.000.000</td>
                <td className="text-center">Perwalikota No. ... Tahun ....</td>
                <td className="ltr:text-right rtl:text-left whitespace-nowrap">
                  <div className="inline-flex ltr:ml-auto rtl:mr-auto">
                    <a href="#" className="btn btn-icon btn_outlined btn_info">
